...
const Template = ({ title, desc1, desc2, image, formType, setIsLoggedIn, addUserData, addAdminData }) => {
  return (
    <div className="flex w-11/12 max-w-[1160px] py-12 mx-auto gap-y-0 gap-x-12 justify-between h-auto">
      <div className="w-11/12 max-w-[450px] mx-0 text-white">
        ...
        {formType === "signup" ? <SignupForm setIsLoggedIn={setIsLoggedIn} addUserData={addUserData} addAdminData={addAdminData} /> : <LoginForm setIsLoggedIn={setIsLoggedIn} />}
